...
// ... or as browser global
	...
	global.Ractive = Ractive;
          ...
          this.RactiveTemplates['app/templates/search_view'] = [{"t":7,"e":"h1","f":"Hello From Ractive"}," ",{"t":7,"e":"p"}," ",{"t":7,"e":"div","a":{"class":"search-list"},"f":[{"t":7,"e":"header","a":{"id":"header"},"f":[{"t":7,"e":"input","a":{"id":"new-search","on-enter-change":"search","placeholder":"What needs to be done?","autofocus":""}}]}]}];
var Song  = {
...
var template = RactiveTemplates["app/templates/search_view"];
console.log(template);
var searchView = new Ractive({
	el: $('#container'),
	template: RactiveTemplates["app/templates/search_view"],
	data: songs
});
